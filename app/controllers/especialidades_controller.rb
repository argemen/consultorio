  ...
  def create
    ...
    respond_to do |format|
      if @especialidad.save
        format.html { redirect_to especialidades_path, notice: 'Especialidad was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @especialidad.update(especialidad_params)
        format.html { redirect_to especialidades_path, notice: 'Especialidad was successfully updated.' }
